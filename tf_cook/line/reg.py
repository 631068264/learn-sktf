...
# 我们必须小心步长。太大的步长，它不会收敛
# reg(loss_func='lasso', max_iter=1500, batch_size=32, learn_rate=0.001)
reg(loss_func='ridge', max_iter=1500, batch_size=32, learn_rate=0.001)
# reg(loss_func='l2', max_iter=1500, batch_size=32, learn_rate=0.01)
# reg(loss_func='l1', max_iter=1500, batch_size=32, learn_rate=0.01)
#
