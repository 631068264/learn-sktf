...
a = sess.run(my_convolution_output, feed_dict=feed_dict)
print(a)
print(a.shape)
...
a = sess.run(my_activation_output, feed_dict=feed_dict)
print(a)
print(a.shape)
...
a= sess.run(my_maxpool_output, feed_dict=feed_dict)
print(a)
print(a.shape)
# Fully Connected Output
print('\nInput = the above array of length 17')
print('Fully connected layer on all four rows with five outputs:')
a = sess.run(my_full_output, feed_dict=feed_dict)
print(a)
print(a.shape)
# ---------------------------------------------------|
# -------------------2D-data-------------------------|
